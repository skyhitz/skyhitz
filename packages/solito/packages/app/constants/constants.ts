...
// Investment and spend thresholds (in HITZ)
// Shares are only granted when amounts invested via the contract are >= 3 HITZ.
...
export const INVEST_MIN_HITZ = 3 // Minimum amount to be considered an investment (shares eligible)
export const MICRO_SPEND_DOWNLOAD_HITZ = 0.3 // Spend before download (no shares)
export const MICRO_SPEND_LIKE_HITZ = 0.2 // Spend on like (no shares)
export const MICRO_SPEND_PLAYBACK_COMPLETE_HITZ = 0.1 // Spend on track completion (no shares)
