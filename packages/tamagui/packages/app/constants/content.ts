...
export const header = {
  title: 'Discover music with Smart Contracts',
  desc: 'The next-gen decentralized music platform, powered by stellar smart contracts, offering music fans, collectors, and creators a groundbreaking way to discover, stream, and invest in unique tracks. Through a decentralized platform, users can access exclusive music while empowering creators with transparent monetization.',
}
