...
// USDC Soroban contract IDs (Soroban SAC wrapper)
// Mainnet: Circle USDC wrapped for Soroban (issuer: GA5ZSEJYB37JRC5AVCIA5MOP4RHTM335X2KGX3IHOJAPP5RE34K4KZVN)
export const USDC_CONTRACT_ID_MAINNET = 'CCW67TSZV3SSS2HXMBQ5JFGCKJNXKZM7UQUWUZPUTHXSTZLEO7SJMI75';
